...
This document explains how to contribute to comply, a REUSE compliance tool written in pure Rust.
...
[pull requests](https://github.com/elioseverojunior/comply/pulls)
or
[issues](https://github.com/elioseverojunior/comply/issues)
via our
[GitHub site](https://github.com/elioseverojunior/comply).
...
- [`docs/contribution.md`](docs/contribution.md) - AI usage policy and contribution guidelines
- [`docs/plan/IMPLEMENTATION.md`](docs/plan/IMPLEMENTATION.md) - Architecture and roadmap

If you want to *change* the criteria (architecture decisions), see [`docs/plan/IMPLEMENTATION.md`](docs/plan/IMPLEMENTATION.md).
...
[issue tracker](https://github.com/elioseverojunior/comply/issues) and
[pull requests](https://github.com/elioseverojunior/comply/pulls).
...
```sh
git config commit.template ~/comply/git-template
```

## Code and Commit Standards

- Avoid emdash `--`, unicode arrow `->` or any unicode characters: `x`, `...` ; use ASCII equivalents instead: `-`, `->`, `x`, `...`
...
- Statement coverage >= 100% (enforced by cargo-tarpaulin in CI)
- New code must have tests

## Governance

This project is led by the project maintainer.
See [`docs/plan/IMPLEMENTATION.md`](docs/plan/IMPLEMENTATION.md) for architecture decisions and roadmap.

## License

All (new) contributed material must be released
under the [Apache-2.0 license](./LICENSE-APACHE) and [MIT license](./LICENSE-MIT) .
