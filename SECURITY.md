...
[main repository's security tab](https://github.com/ossf/best-practices-badge/security), in the left sidebar, under "Reporting", click
...
Elio Severo Junior <elioseverojunior@gmail.com> and
Elio Severo Junior <elio@elio.eti.br>.
...
[security policy](SECURITY.md) and [contributing guidelines](CONTRIBUTING.md).
