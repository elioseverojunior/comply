...
[The year is added for you](/docs/reference/cli#the-year-is-added-for-you).
...
The full table is in [Copyright forms](/docs/reference/cli#copyright-forms). The
...
now requires a header to be _in a comment_.
