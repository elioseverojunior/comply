...
export default defineConfig({
  ...
  head: [
    ...
    ["meta", { property: "og:title", content: "comply -- REUSE compliance in pure Rust" }],
  ],
  ...
  themeConfig: {
    nav: [
      ...
      { text: "Parity", link: "/PARITY" },
      {
        text: "0.1.0",
        items: [
          { text: "Changelog", link: "https://github.com/elioseverojunior/comply/blob/main/CHANGELOG.md" },
          { text: "Contributing", link: "https://github.com/elioseverojunior/comply/blob/main/CONTRIBUTING.md" },
        ],
      },
    ],
    ...
    editLink: {
      pattern: "https://github.com/elioseverojunior/comply/edit/main/docs/:path",
