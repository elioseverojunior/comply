...
```mermaid
gantt
    title comply implementation roadmap
    dateFormat  YYYY-MM-DD
    axisFormat  %Y-%m-%d

    section Milestones
    Phase 1-2 complete         :milestone, m1, 2026-07-15, 0d

    section Phase 1-2 -- Core library + CLI (DONE)
    SPDX parser                :p1a, 2026-07-10, 3d
    Header detector/generator  :p1b, 2026-07-11, 3d
    File discovery             :p1c, 2026-07-12, 2d
    License DB                 :p1d, 2026-07-13, 2d
    Config + Report + Hash     :p1e, 2026-07-14, 2d
    CLI subcommands            :p2, 2026-07-15, 1d

    section Phase 3 -- Advanced surfaces
    WASM target                :p3a, 2026-10-01, 30d
    LSP server                 :p3b, 2026-10-15, 45d
    MCP server                 :p3c, 2026-12-01, 30d
```
